  ...
  config = lib.mkIf cfg.enable {
    ...
    environment.systemPackages = utils.removePackagesByName (
      ...
      ++ [
        ...
        cosmic-applibrary
        cosmic-bg
        (cosmic-comp.override { useXWayland = config.services.desktopManager.cosmic.xwayland.enable; })
        cosmic-edit
        cosmic-files
        cosmic-greeter
        cosmic-icons
      ...
      ++ lib.optionals config.services.flatpak.enable [ cosmic-store ]
